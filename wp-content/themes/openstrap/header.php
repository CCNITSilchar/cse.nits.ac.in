...
<?php
	...
	?>
		...
		<link rel="stylesheet" type="text/css" href="http://cse.nits.ac.in/wp-content/uploads/2015/09/font.css" />
		

		<?php if ( is_page('members') ) {
			echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"http://cse.nits.ac.in/wp-content/uploads/2015/09/css1.css\">";
		} ?>
		<?php if ( is_page('members-15-16')  ) {
			
			echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"http://cse.nits.ac.in/wp-content/uploads/2015/09/common.css\">";
			echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"http://cse.nits.ac.in/wp-content/uploads/2015/09/society.css\">";
		...
		<div class="header-body">		
			<div class="container">
				 <div class="row logo-row">
				  <div class="col-md-4 pull-left" style="width:90%; float:left; margin-bottom:5px;">
					<?php if ( $site_logo != '' ) : ?>
					<a href="<?php echo esc_url( home_url( '/' )); ?>" style="float:left;"><img src="<?php echo esc_url($site_logo); ?>" alt="<?php bloginfo('description'); ?>" class="img-responsive" style="float:left; height:80px; margin:10px 10px auto auto;" /></a>
...
<h2 style="align:left; color:#dd4800; font-size:200%; text-decoration:none;">Department of Computer Science and  Engineering</h2>
<h4 style="color:#3450A7; font-size:110%;">
National Institute Of Technology Silchar</h4></div>

				
				  </div>	  
				  <div class="col-md-8 hidden-xs" style="margin-left:0px;">
	...
	<div class="row" id="main-row" style="padding-bottom:20px;">