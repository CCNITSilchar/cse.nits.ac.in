...
<?php
	...
	//Performing Queries
			...
			$d[2]=mysqli_real_escape_string($connection,$_POST['problem']);
		...
		if($result)
		 {		//Closing Connection
					...
					echo '<br><center><h2 style="color:#dd4814; margin-left-auto; margin-right:auto;">Thank You for reporting. We will fix this as soon as possible.</h1><img src="redirecting.gif"><br>';
